...
initial
   begin
     ...
     fftpts_array[2]=4096;
     fftpts_array[3]=4096;
     data_rf = $fopen("FFT_mf_real_input.txt","r");
     data_if = $fopen("FFT_mf_imag_input.txt","r");
     fft_rf = $fopen("FFT_mf_real_output_ver.txt");
     fft_if =$fopen("FFT_mf_imag_output_ver.txt");
     expf = $fopen("FFT_mf_exponent_output_ver.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
